    ...
    <section id="prizes" className="py-20 relative bg-black">
      <div className="container mx-auto px-6">
            ...
            return (
              <div
                ...
                className={`bg-gray-800/30 p-8 rounded-lg ${
                  colorClasses.bg
                } transition-all duration-300 group cursor-pointer text-center animate-fade-in-up ${
                  prize.title === "1st Place" ? "md:col-span-1" : ""
                }`}
                style={{ animationDelay: `${index * 200}ms` }}
              >
                <Icon
                  className={`h-16 w-16 ${colorClasses.icon} mx-auto mb-6 group-hover:scale-110 transition-transform duration-300`}
                />
                <h3
                  className={`text-2xl font-semibold mb-2 ${colorClasses.title}`}
                >
                  {prize.title}
                </h3>
        ...
        <div className="text-center mt-12">
          <div className="inline-block p-6 bg-gray-900/20 rounded-lg">
            <p className="text-lg text-gray-300">
              All winners will receive certificates and exclusive Nepathon
              merchandise.
              <br />
              <span className="text-yellow-500 font-semibold">
                Network with industry leaders and get mentorship opportunities!
              </span>
            </p>
          </div>
        </div>

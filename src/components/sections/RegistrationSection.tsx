  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (incompleteMembers) {
      toast({
        ...
        description:
          "Please ensure all team members have filled all required fields.",
        variant: "destructive",
      });
      return;
    }
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <Label htmlFor="teamName" className="text-foreground/80">
                      Team Name
                    </Label>
                    <Input
                      id="teamName"
                  ...
                  <div>
                    <Label htmlFor="memberCount" className="text-foreground/80">
                      Number of Members
                    </Label>
                    <Select
                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <Input id="leaderPhone" name="leaderPhone" required />
                      </div>
                      <div>
                        <Label
                          htmlFor="leaderEmail"
                        ...
                        <Input id="leaderEmail" name="leaderEmail" required />
                      </div>
                      <div>
                        <Label
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Button
                    ...
                    disabled={
                      teamMembers.length >= parseInt(formData.memberCount) - 1
                    }
                  >
                    Add Member
                  </Button>
                ...
                {teamMembers.map((member, index) => (
                  <div key={member.id} className="space-y-4 mb-6">
...
const sendToGoogleSheets = async (formData, teamMembers) => {
  try {
    ...
    const appsScriptUrl =
      "https://script.google.com/macros/s/AKfycbwOItLe58iexnq5qiJzGtT0WF0ZRht7_xFiwbvlWLU_arZCSjF8d_V_cduvesIxJFybxw/exec";
    ...
    try {
      ...
      throw new Error(
        `Invalid JSON response from server: ${jsonError.message}, response text: ${text}`
      );
    }
